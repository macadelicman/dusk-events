...
ActiveRecord::Schema[8.0].define(version: 2025_04_16_051121) do
  ...
  create_table "events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["img_url"], name: "index_events_on_img_url"
    t.index ["location"], name: "index_events_on_location"
    t.index ["name"], name: "index_events_on_name"
    t.index ["page_views"], name: "index_events_on_page_views"
    t.index ["status"], name: "index_events_on_status"
    t.index ["thumb_url"], name: "index_events_on_thumb_url"
  end
